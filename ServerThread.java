...
class ServerThread implements Runnable {
    ...
    private static final String DOCUMENT_ROOT = System.getenv("WEBSERVER_PATH");
    private static final String ERROR_DOCUMENT = DOCUMENT_ROOT + "/error_document";
    ...
    public void run() {
        ...
        try {
            ...
            if(path == null) {return;}
            if(path.equals("http://localhost:8001/") || path.equals("/")) {
                path += "index.html";
                ext = "html";
            }
